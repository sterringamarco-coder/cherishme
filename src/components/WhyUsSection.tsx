...
const features = [
  ...
  },
  {
    ...
    detail: "Situated in the centre of Bangpor's scenic beachfront, we're a short and easy drive from the famous Fisherman's Village walking street. Many guests combine a visit to the night market with an unforgettable dinner at Cherish Samui Restaurant and Bar.",
  },
];
