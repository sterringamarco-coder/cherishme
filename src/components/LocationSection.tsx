    ...
    <div className="container mx-auto px-4 max-w-6xl">
      ...
      >
        ...
        <p className="font-body text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-3">
          Located in Bangpor, just 11 km from Fisherman's Village (a quick 15-minute drive), Cherish Samui Restaurant and Bar
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3930.0!2d99.9395106!3d9.5780525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3054f7cc2a2fc193%3A0x62b641a5bf5c1c2e!2sCherish%20Restaurant%20%26%20Bar!5e0!3m2!1sen!2sth!4v1"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-body text-sm text-muted-foreground">
                92/32 Bang Po, Koh Samui, Suratthani 84330<br />
