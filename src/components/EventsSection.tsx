...
const events = [
  ...
  },
  {
    ...
    desc: "Say 'I do' or pop the question with the golden Koh Samui sunset as your backdrop. Cherish Samui hosts intimate beach weddings and romantic proposals with candlelit setups, flowers, and bespoke menus crafted for your special moment.",
  },
  {
    icon: Users,
    ...
    <div className="container mx-auto px-4 max-w-5xl">
      ...
      >
        ...
        <p className="font-body text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-4">
          Looking for the ideal event venue in Koh Samui? Cherish Samui transforms
      ...
      >
        To enquire about hosting your event at Cherish Samui, please contact us
